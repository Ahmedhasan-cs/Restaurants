...
```bash
POST https://raisin-coding-challenge.glitch.me/api/v1/login
...
```bash
curl -X POST https://raisin-coding-challenge.glitch.me/api/v1/login \
...
```bash
GET https://raisin-coding-challenge.glitch.me/api/v1/cuisines
```

```bash
curl --location --request GET 'https://raisin-coding-challenge.glitch.me/api/v1/cuisines'
```
